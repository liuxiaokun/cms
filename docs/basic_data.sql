...
DELETE FROM `cms_core`.`user` WHERE `user_id`='1';
INSERT INTO `cms_core`.`user` (`user_id`, `email`, `mobile`, `password`, `salt`, `is_active`, `is_email_verified`, `is_mobile_verified`, `client_ip`, `created`, `updated`, `last_login`, `last_ip`) VALUES ('1', 'liuxiaokun0410@qq.com', '18521599183', 'password', 'ssss', '1', '1', '1', '0', '2014-01-01 21:12:38', '2014-01-01 21:16:38', '2014-01-01 21:15:38', '0');
